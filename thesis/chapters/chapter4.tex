...
\item 编码当前系统状态
\item 使用 $\varepsilon$-greedy 策略选择调度策略
\item 使用选中的调度策略选择符合条件进程
...
\item \texttt{NACTION} 表示动作空间大小
\end{itemize}
系统在每次调度时根据当前状态查找对应 Q 值，并选择 Q 值最大的进程。
